...
object TuplesAndMaps extends App {
    ...
    val aPhoneBook =
        Map(("Jim", 555), "Daniel" -> 789, ("JIM", 900)).withDefaultValue(-1)
    ...
    val names = List("Bob", "James", "Mohamed", "Samy", "Jim", "Salim")
    println(names.groupBy(name => name.charAt(0)))

    /* exercises:
        1. what would happen if I had two original entries "Jim" -> 555 and "JIM"-> 900 ?
        ! careful with mapping keys
        2. Build an overly simplified social network based on maps
            Person = String
    ...
    def remove(
        ...
        def removeAux(
            ...
            if (friends.isEmpty) networkAcc
                ...
                removeAux(
                  friends.tail,
                  unfriend(networkAcc, person, friends.head)
                )
    ...
    def nPeopleWithNoFriends(network: Map[String, Set[String]]): Int =
        ...
        // network.count(pair => pair._2.isEmpty) // all these are equivalents
